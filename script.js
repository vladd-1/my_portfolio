...
// Observe all sections and cards with stagger
document.querySelectorAll('section, .project-card, .cert-card, .achievement-item, .timeline-item, .experience-card, .skill-category').forEach((el, index) => {
    el.style.opacity = '0';
